...
class DataSet():
    ...
    def frame_generator(self, batch_size, train_test, data_type, augmentation= False):
        ...
        while 1:
            ...
            for _ in range(batch_size):
                ...
                if augmentation: sample, label = self.augment(sequence, self.get_class_one_hot(sample[1]))
